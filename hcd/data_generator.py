...
class TableAPIDataGenerator:
    ...
    def generate_uuid(self) -> uuid.UUID:
        """Generate a random UUID object for CQL."""
        return uuid.uuid4()
    ...
    def generate_metadata_date(self, field_name: str) -> datetime:
        """Generate realistic date data for metadata field as datetime object."""
        # CQL expects datetime objects for TIMESTAMP columns
