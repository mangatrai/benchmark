"""
CQL Data Generator for AstraDB benchmarking.
Generates data matching the sample_price_1 table structure.
"""
...
class CQLDataGenerator:
    ...
    def __init__(self, chunk_size: int = 512, embedding_dim: int = 1536):
        """Initialize the CQL data generator.
        ...
        logger.info(f"CQLDataGenerator initialized: chunk_size={chunk_size}, embedding_dim={embedding_dim}")
    ...
    def generate_metadata_date(self, field_name: str) -> datetime:
        """Generate realistic date data for metadata field."""
